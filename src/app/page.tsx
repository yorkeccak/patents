      ...
      <div className="flex-1 flex flex-col pt-0">
        ...
        <AnimatePresence mode="wait">
            {!hasMessages && (
              ...
              >
                Enterprise-grade patent search infrastructure, designed from the ground up for agentic knowledge work.
                Powered by Valyu&apos;s proprietary semantic search across 100M+ patents.
              </motion.p>
            </motion.div>
          )}
        </AnimatePresence>
